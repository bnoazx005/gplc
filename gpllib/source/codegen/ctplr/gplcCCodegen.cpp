...
namespace gplc
{
	...
	TLLVMIRData CCCodeGenerator::VisitArrayTypeNode(CASTArrayTypeNode* pNode)
	{
		return {};
	}

	TLLVMIRData CCCodeGenerator::VisitIndexedAccessOperator(CASTIndexedAccessOperatorNode* pNode)
	{
		return {};
	}
